    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宠物用品分类" prop="shangpinValue">
                        <el-input v-model="shangpinForm.shangpinValue"
                                  placeholder="宠物用品分类" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="备注" prop="shangpinOrderCourierBeizhu">
                       <el-input v-model="ruleForm.shangpinOrderCourierBeizhu"
                                 placeholder="备注" clearable  :readonly="ro.shangpinOrderCourierBeizhu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="备注" prop="shangpinOrderCourierBeizhu">
                           <el-input v-model="ruleForm.shangpinOrderCourierBeizhu"
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    shangpinOrderCourierBeizhu: false,
