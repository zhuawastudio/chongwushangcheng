    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '宠物用品分类' : ''">
            <el-select v-model="searchForm.shangpinTypes" placeholder="请选择宠物用品分类">
              <el-option label="=-请选择-=" value=""></el-option>
              <el-option
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <a style="text-decoration:none" class="el-button el-button--success"
               ...
               href="http://localhost:8080/chongwushangcheng/upload/shangpinOrderMuBan.xls"
            >批量导入商品订单数据模板</a>
            &nbsp;
            <el-upload
                v-if="isAuth('shangpinOrder','导入导出')"
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           prop="shangpinOrderCourierBeizhu"
                           header-align="center"
                           label="备注">
            <template slot-scope="scope">
              {{ scope.row.shangpinOrderCourierBeizhu }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button
                  ...
                  type="primary" icon="el-icon-reading" size="mini" @click="openCommentModel(scope.row.id)">评价
              </el-button>
    ...
    <el-dialog title="发货" :visible.sync="deliverVisible" width="30%">
      <el-form>
        ...
        <el-form-item label="备注">
          <el-input v-model="shangpinOrderCourierBeizhu" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  data() {
    return {
      ...
      // 备注
      shangpinOrderCourierBeizhu: null,
      //模态框状态
      ...
      json_fields: {
        ...
        '商品照片': 'shangpinPhoto',
        '宠物用品分类': 'shangpinTypes',
        '库存': 'shangpinKucunNumber',
        '金额': 'shangpinNewMoney',
        '用户姓名': 'yonghuName',
        '用户手机号': 'yonghuPhone',
  ...
  methods: {
    ...
    openDeliver(id) {
      ...
      //备注
      this.shangpinOrderCourierBeizhu=null;
      //赋值
      this.deliverId = id;
      //打开模态框
    ...
    deliver() {
      ...
      if (this.shangpinOrderCourierBeizhu == ""
          || this.shangpinOrderCourierBeizhu == null
          || this.shangpinOrderCourierBeizhu == "null") {
      ...
      _this.$confirm(`确定要发货吗?`, "提示", {
        ...
        _this.$http({
          url: "shangpinOrder/deliver?id=" + id + "&shangpinOrderCourierNumber=" + _this.shangpinOrderCourierNumber + "&shangpinOrderCourierName=" + _this.shangpinOrderCourierName+ "&shangpinOrderCourierBeizhu=" + _this.shangpinOrderCourierBeizhu,
          method: "post",
        }).then(({data}) => {
          if (data && data.code === 0) {
            _this.$message({
