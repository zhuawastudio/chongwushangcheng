        ...
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物用品分类" prop="shangpinTypes">
                        <el-select v-model="ruleForm.shangpinTypes" :disabled="ro.shangpinTypes" placeholder="请选择宠物用品分类">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="宠物用品分类" prop="shangpinValue">
                        <el-input v-model="ruleForm.shangpinValue"
                            placeholder="宠物用品分类" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="库存" prop="shangpinKucunNumber">
                       <el-input v-model="ruleForm.shangpinKucunNumber"
                                 placeholder="库存" clearable  :readonly="ro.shangpinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="库存" prop="shangpinKucunNumber">
                           <el-input v-model="ruleForm.shangpinKucunNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="金额" prop="shangpinNewMoney">
                       <el-input v-model="ruleForm.shangpinNewMoney"
                                 placeholder="金额" clearable  :readonly="ro.shangpinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="金额" prop="shangpinNewMoney">
                           <el-input v-model="ruleForm.shangpinNewMoney"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinTypes: [
                              { required: true, message: '宠物用品分类不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
