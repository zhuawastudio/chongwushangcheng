    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">宠物商城网站系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="商家信用类型" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaXingjiTypes" autocomplete="off" placeholder="商家信用类型"  />
                           </el-form-item>
                        -->
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='shangjia'">
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/chongwushangcheng/img/back-img-bg.jpg);
