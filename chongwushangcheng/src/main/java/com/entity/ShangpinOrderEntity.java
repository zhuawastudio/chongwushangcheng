...
public class ShangpinOrderEntity<T> implements Serializable {
    ...
    @TableField(value = "shangpin_order_courier_beizhu")

    private String shangpinOrderCourierBeizhu;
	 ...
	 * 获取：备注
	 */
    public String getShangpinOrderCourierBeizhu() {
        return shangpinOrderCourierBeizhu;
    }
    /**
	 * 设置：备注
	 */

    public void setShangpinOrderCourierBeizhu(String shangpinOrderCourierBeizhu) {
        this.shangpinOrderCourierBeizhu = shangpinOrderCourierBeizhu;
    }
    /**
	 * 获取：订单类型
	 */
    ...
    public String toString() {
        return "ShangpinOrder{" +
            ...
            ", shangpinOrderCourierBeizhu=" + shangpinOrderCourierBeizhu +
